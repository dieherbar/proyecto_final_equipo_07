...
export default function MyHeader(props) {
  return (
    <>
      <Navbar expand="lg" variant="light" bg="white" fixed="top" className={styles.bar}>
        <Container>
          <Navbar.Brand>
      ...
      {[false].map((expand) => (
        <Navbar key={expand} bg="white" expand={expand} className="mb-3">
          <Container fluid>
            ...
            >
              ...
              <Offcanvas.Body>
                <Nav className="justify-content-end flex-grow-1 pe-3">
                  <Nav.Link href="#action1"><img className={styles.logoP1} src="/LogoP.png"></img></Nav.Link>
                  <Offcanvas.Title id={`offcanvasNavbarLabel-expand-${expand}`}  style={{fontSize:"x-large", textAlign:"center"}}>
            ...
            <Navbar.Brand href="#"><img className="logo" src="/PedidosYa.png"></img></Navbar.Brand>
          </Container>
        </Navbar>
      ))}
